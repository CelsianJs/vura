...
describe('lambda adapter clean tarball smoke', () => {
  it('resolves @celsian/vura-core from flattened clean installs', async () => {
    ...
    try {
      ...
      const nestedCore = join(app, 'node_modules/@celsian/vura-adapter-lambda/node_modules/@celsian/vura-core');
...
const mod = await import(${JSON.stringify('file://' + join(app, 'node_modules/@celsian/vura-adapter-lambda/dist/index.js'))});
