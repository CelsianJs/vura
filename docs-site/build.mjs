...
const GITHUB_LINK = `<a href="https://github.com/zvndev/vura" class="nav-github" target="_blank" rel="noopener">
...
const FOOTER_INNER = `
    <span>MIT licensed — forever. See <a href="https://github.com/zvndev/vura/blob/main/GOVERNANCE.md" target="_blank" rel="noopener">GOVERNANCE.md</a></span>
