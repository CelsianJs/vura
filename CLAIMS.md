...
| 16 | Package tarball sizes | `scripts/package-size-limits.json` | `pnpm run package:size` — tracked ceilings: core 138 KB, compiler 15 KB, CLI 50 KB, create-vura 10 KB, Cloudflare adapter 15 KB, Lambda adapter 18 KB, managed Vura adapter 15 KB, and Vite plugin 16 KB. These are **ceiling limits**, not marketing numbers; do not quote them as "tiny" or "lightweight" without a real comparative baseline. | verified as limits (not marketing claims — do not quote in prose) |
